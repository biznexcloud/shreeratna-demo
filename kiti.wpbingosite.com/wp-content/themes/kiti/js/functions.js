...
( function( $ ) {
	...
	function _headercategories(){
		...
		$('.kiti-close',$menu_categories).on( "click", function() {
			$menu_categories.removeClass('active');
			return false;
		});		
		//Navigation right			
	...
	function _canvasrightNavigation(){
		...
		$('.kiti-close',$wpbingo_menu_right).on( "click", function() {
			$wpbingo_menu_right.removeClass('active');
			return false;
		});		
		//Navigation right			
		...
		$(".input-search",$element).on("keydown", function() {
			...
			if(character.length >= 2){
				...
				$.ajax({
					...
					dataType: 'json',
					data: {
						action : "kiti_search_products_ajax",
						character : character,
						limit : limit,
						category : category
					},
	...
	function _load_360_view_product(){
		...
		$(".kiti-360-button").on( "click", function() {
	...
	function _after_add_to_cart(){
		$( _body ).on( 'added_to_cart', function(){
			_click_add_to_cart();
			$('body').append('<div class="kiti-product-added"><div class="added-message">'+$(".mini-cart").data("text_added")+'</div>');
			setTimeout(function(){
				$('.kiti-product-added').remove();
			},3000);
		});
	}
	function _click_add_to_cart(){
		...
		$(".cart-icon").on( "click", function() {
			if( !_body.hasClass("not-scroll") && $(".kiti-topcart").hasClass("popup") ){
